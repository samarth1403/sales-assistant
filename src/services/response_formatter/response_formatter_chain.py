...
from .response_formatter_examples import response_formatter_examples
from .response_formatter_prompt_prefix import response_formatter_prompt_prefix

def get_response_formatter_chain() -> Runnable[Dict[str, Any], str]:
    # GEMINI AI MODEL
    ...
    response_formatter_example_prompt = PromptTemplate.from_template(
         """User Question:{question}\nSQL Result:{result}\nAssistant Response:{response}\n"""
    )

    response_formatter_few_shot_prompt = FewShotPromptTemplate(
        examples = response_formatter_examples,
        example_prompt=response_formatter_example_prompt,
        input_variables=["question","result"],
        prefix=response_formatter_prompt_prefix,
    ...
    response_formatter_generator_chain = cast(
        ...
        response_formatter_few_shot_prompt | llm_model | output_parser,
    )
